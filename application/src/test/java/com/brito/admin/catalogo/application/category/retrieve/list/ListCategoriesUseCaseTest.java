package com.brito.admin.catalogo.application.category.retrieve.list;

import com.brito.admin.catalogo.application.catgory.retrieve.list.CategoryListOutput;
